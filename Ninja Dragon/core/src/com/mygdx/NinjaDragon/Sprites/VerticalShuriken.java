...
public class VerticalShuriken extends Sprite implements Pool.Poolable {

    private float stateTime;
    public Body b2body;
    public boolean alive;
    private CircleShape verticalShuriken;
    ...
    public void init(PlayState state,TextureAtlas atlas, Rectangle bounds) {
        ...
        if (verticalShuriken == null) {
            ...
            createBody();
            fdef.shape = getBody();
            fdef.filter.categoryBits = NinjaDragon.V_SHURIKEN_BIT;
    ...
    public void reverseVelocity(boolean y){
        if(y) {
            reverseY = !reverseY;
        }
    }
    ...
    private void setBody(CircleShape verticalShuriken) {
        this.verticalShuriken = verticalShuriken;
    }

    public CircleShape getBody() {
        return verticalShuriken;
    }
